...
const Hero = () => {
  return (                        
    <section className='bg-[linear-gradient(rgba(0,0,0,0.3),rgba(0,0,0,0.3)),url(/images/hero.png)] bg-cover bg-center h-screen bg-fixed flex items-end justify-center'>
